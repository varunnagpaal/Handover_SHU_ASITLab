function csvdata = eva(name)
    ...
    ref1 = imread([name, '\', name, '_gimp20.ppm']);
    ref2 = imread([name, '\', name, '_gimp30.ppm']);
    ref3 = imread([name, '\', name, '_gimp40.ppm']);
    ref4 = imread([name, '\', name, '_gimp50.ppm']);
    ref5 = imread([name, '\', name, '_gimp60.ppm']);
    ref6 = imread([name, '\', name, '_gimp70.ppm']);
    ref7 = imread([name, '\', name, '_gimp80.ppm']);
    ref8 = imread([name, '\', name, '_gimp90.ppm']);
    ref9 = imread([name, '\', name, '_gimp100.ppm']);
    ...
    clear filename
    filename(1, :) = [name, '/', name, '_gimp20.ppm '];
    filename(end + 1, :) = [name, '/', name, '_gimp30.ppm '];
    filename(end + 1, :) = [name, '/', name, '_gimp40.ppm '];
    filename(end + 1, :) = [name, '/', name, '_gimp50.ppm '];
    filename(end + 1, :) = [name, '/', name, '_gimp60.ppm '];
