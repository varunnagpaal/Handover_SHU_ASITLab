...
% 环状方式一直做到 2x2
function [size_all, blk_size_sum, split_frame, mode_frame, CTU_bits] = encode_main_comb_loop22(srcy)
    initGlobals(100);
    ...
    for i = 1:numel(CTU)
        % for i = 1:2
        i
        [CTU_bits(i), img_rebuild, split_frame, mode_frame] = encode_CTU_comb_loop22(CTU(i), img_src, img_rebuild, split_frame, mode_frame);
    end
