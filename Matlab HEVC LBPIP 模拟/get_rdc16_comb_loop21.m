% 块状方法和环状方法分别编码 16*16 块，择优，返回 rdcost
% 环状方式一直做到 1x1
function [img_rebuild, split_frame, mode_frame, rdc] = get_rdc16_comb_loop21(x, y, img_src, img_rebuild, split_frame, mode_frame, rdc_deep_layer, rdc_ind)
    PU = 16; %4 8 16 32 64
