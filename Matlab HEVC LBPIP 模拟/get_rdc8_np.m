% 应用新分块方法编码一个 8x8 块
function [img_rebuild, split_frame, mode_frame, loop_flag_frame, rdc, rdc_res_part, rb_loop_reuse] = get_rdc8_np(x, y, img_src, img_rebuild, split_frame, mode_frame, loop_flag_frame, rdc_deep_layer, rdc_ind, rdc_deep_layer_res_part, rb_loop_reuse_deep_layer)
    PU = 8; %4 8 16 32 64
