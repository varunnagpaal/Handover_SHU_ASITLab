...
function [CTU_bits, img_rebuild, split_frame, mode_frame] = encode_CTU_comb(CTU, img_src, img_rebuild, split_frame, mode_frame)
    ...
    for i = 1:341
        ...
        switch z_size_mat(i)
            ...
            case 16
                [img_rebuild, split_frame, mode_frame, rdc_16(rdc_ind)] = get_rdc16_comb(x, y, img_src, img_rebuild, split_frame, mode_frame, rdc_8, rdc_ind);

            case 32
                [img_rebuild, split_frame, mode_frame, rdc_32(rdc_ind)] = get_rdc32_comb(x, y, img_src, img_rebuild, split_frame, mode_frame, rdc_16, rdc_ind);

            case 64
                [img_rebuild, split_frame, mode_frame, rdc_64(rdc_ind)] = get_rdc64_comb(x, y, img_src, img_rebuild, split_frame, mode_frame, rdc_32, rdc_ind);
