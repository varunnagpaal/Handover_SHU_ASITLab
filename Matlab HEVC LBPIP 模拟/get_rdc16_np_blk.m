% 应用新分块方法编码一个 8x8 块
function [img_rebuild, split_frame, mode_frame, rdc, rdc_res_part] = get_rdc16_np_blk(x, y, img_src, img_rebuild, split_frame, mode_frame, rdc_deep_layer, rdc_ind, rdc_deep_layer_res_part)
    PU = 16; %4 8 16 32 64
